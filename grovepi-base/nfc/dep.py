...
class ATR_REQ(ATR_REQ_RES):
    PDU_CODE = bytearray.fromhex('D400')
    PDU_NAME = 'ATR-REQ'
...
class ATR_RES(ATR_REQ_RES):
    PDU_CODE = bytearray.fromhex('D501')
    PDU_NAME = 'ATR-RES'
    PDU_SHOW = "{self.PDU_NAME} NFCID3={nfcid3} DID={self.did:02x} "\
...
class PSL_REQ(PSL_REQ_RES):
    PDU_CODE = bytearray.fromhex('D404')
    PDU_NAME = 'PSL-REQ'
...
class PSL_RES(PSL_REQ_RES):
    PDU_CODE = bytearray.fromhex('D505')
    PDU_NAME = 'PSL-RES'
...
class DEP_REQ(DEP_REQ_RES):
    PDU_CODE = bytearray.fromhex('D406')
    PDU_NAME = 'DEP-REQ'
    
class DEP_RES(DEP_REQ_RES):
    PDU_CODE = bytearray.fromhex('D507')
    PDU_NAME = 'DEP-RES'
...
class DSL_REQ(DSL_REQ_RES):
    PDU_CODE = bytearray.fromhex('D408')
    PDU_NAME = 'DSL-REQ'
    
class DSL_RES(DSL_REQ_RES):
    PDU_CODE = bytearray.fromhex('D509')
    PDU_NAME = 'DSL-RES'
...
class RLS_REQ(RLS_REQ_RES):
    PDU_CODE = bytearray.fromhex('D40A')
    PDU_NAME = 'RLS-REQ'
    
class RLS_RES(RLS_REQ_RES):
    PDU_CODE = bytearray.fromhex('D50B')
    PDU_NAME = 'RLS-RES'
